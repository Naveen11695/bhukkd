...
void send_data_to_firestore(NearByRestaurants nearby_restaurants) async {
...
//        "photo_url":[nearby_restaurants.photo_url],
        ...
        "is_table_reservation_supported":[nearby_restaurants.is_table_reservation_supported],
